...
export const CreatorTooltip: React.FC<CreatorTooltipProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      {show && score && (
        <div className={`absolute left-1/2 -translate-x-1/2 top-full mt-2 z-50 w-64 rounded-lg border shadow-lg p-3 ${
          theme === 'light'
          ...
          <div className="space-y-2">
            ...
            <ScoreBar label="Bio 品类匹配" value={score.breakdown.bioCategory} max={15} theme={theme} />
